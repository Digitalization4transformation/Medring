    ...
    <>
      <div className="flex min-h-screen">
        <div className="flex w-full flex-col md:flex-row">
          {/* Image */}
          <div className="md:bg-[#0aa4ac] md:min-h-screen flex flex-wrap md:w-1/2">
          ...
          <div className="flex flex-col md:flex-1 items-center justify-center">
            <div className="loginWrapper flex flex-col w-full lg:px-36 md:px-8 px-8 md:py-8">
                ...
                <form onSubmit={register}>
                  ...
                  <div className="flex items-center mb-6 -mt-2 md:-mt-4">
                    <div className="flex ml-auto">
                      <Link
                        ...
                        className="inline-flex font-semibold text-xs sm:text-sm text-[#0aa4ac] hover:text-[#0aa4ac]"
                      >
                        Forgot password?
                      </Link>
                    </div>
                  ...
                  <div className="flex w-full">
                    <button
                      disabled={loading}
                      type="submit"
                      className="flex items-center justify-center focus:outline-none text-white text-sm bg-[#0aa4ac] hover:bg-[#10bbc4] rounded-lg md:rounded md:py-2 py-3 w-full transition duration-150 ease-in"
                    >
              ...
              <div className="flex justify-center items-center my-6 md:mb-0">
                <Link
                  to="/auth/login"
                  className="inline-flex items-center font-bold text-[#0aa4ac] hover:text-[#0aa4ac] text-xs text-center"
                >
                  <span>
                    <svg
                      className="h-6 w-6"
